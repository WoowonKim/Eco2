...
// 신고글 조회
export const reportList = createAsyncThunk("reportSlice/reportList", async (args, rejectWithValue) => {
  try {
...
//신고 상세 내역 조회
export const reportDetailList = createAsyncThunk("reportSlice/reportDetailList", async (args, rejectWithValue) => {
  try {
...
//신고승인
export const reportAccept = createAsyncThunk("reportSlice/reportAccept", async (args, rejectWithValue) => {
  try {
...
//신고반려
export const reportCancle = createAsyncThunk("reportSlice/reportCancle", async (args, rejectWithValue) => {
  try {
